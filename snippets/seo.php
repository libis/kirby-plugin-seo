...
$og = [
  'title' => $page->og_title() != "" ? $page->og_title() : $page->seoTitle(),
  'description' => $page->og_description() != "" ? $page->og_description() : $site->site_meta_description(),
  'image' => $page->og_image()->toFile() != "" ? $page->og_image()->toFile()->url() : ($site->og_default_image()->toFile() != "" ? $site->og_default_image()->toFile()->url() : ""),
  'url' => $page->url(),
  'site_name' => $site->og_site_name(),
  'type' => "Website",
];
?>
